...
for c = cn
    v = rmfield(eval(['data_desired_order_3D' strrep(c{3},'.grid','')]), 'grid');
    eval(['data_desired_order_3D' strrep(c{3},'.grid','') '=v;'])
    v = rmfield(eval(['data_sweep_order_3D' strrep(c{3},'.grid','')]), 'grid');
    eval(['data_sweep_order_3D' strrep(c{3},'.grid','') '=v;'])
end
